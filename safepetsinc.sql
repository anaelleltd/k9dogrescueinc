/*Create the database */
CREATE DATABASE safepetsinc;

USE DATABASE safepetsinc;
...
INSERT INTO BRAND_SPONSORS (ABN, BUSINESS_NAME, WEBSITE) VALUES
(97069368234, 'PET CITY', 'https://www.petcitywa.com.au'),
(93470892841, 'MURPHYS IRISH PUB', 'http://www.murphysirishpub.com.au/'),
(54483191873, 'PORT KENNEDY VETERINARY HOSPITAL', 'https://portkennedyvet.com.au/');

INSERT INTO NFP_ORGANISATIONS (ORGANISATION_NAME, ORGANISATION_WEBSITE, ADDRESS, CITY, POSTCODE, STATE) VALUES
('K9 RESCUE GROUP INC', 'http://www.k9dogrescue.org.au/index.html', 'PO Box 220', 'Mandurah', '6210', 'WA');
...
INSERT INTO KENNELS (KENNEL_NUMBER, ADDRESS, CITY, POSTCODE, STATE, ORGANISATION_NAME, DOG_NAME) VALUES
(1, '58 Sunshine Place', 'Nambeelup', '6207' ,'WA', 'K9 RESCUE GROUP INC', 'Chevvy'),
(2, '58 Sunshine Place', 'Nambeelup', '6207' ,'WA', 'K9 RESCUE GROUP INC', 'Butch'),
(3, '58 Sunshine Place', 'Nambeelup', '6207' ,'WA', 'K9 RESCUE GROUP INC', 'Durah'),
(4, '58 Sunshine Place', 'Nambeelup', '6207' ,'WA', 'K9 RESCUE GROUP INC', 'Yogi'),
(5, '58 Sunshine Place', 'Nambeelup', '6207' ,'WA', 'K9 RESCUE GROUP INC', 'Marnie');

INSERT INTO DOGS (DOG_NAME, DOB, SEX, BREED, SIZE, VET_CHECKS, KENNEL_NUMBER, STAFF_ID, SPONSOR_PHONE) VALUES
('Chevvy', '2017-10-08' , 'F', 'Rottweiler', 'M', 'Y', 1, 'C0004', 0495810018),
('Butch', '2017-05-15' , 'M', 'Husky x Mastiff', 'L', 'Y', 2, 'C0002', 0495810012),
('Durah', '2012-04-01' , 'F', 'Mastiff x', 'M', 'Y', 3, 'C0005', 0495810015),
('Yogi', '2017-02-24' , 'M', 'Mastiff', 'L', 'Y', 4, 'C0004', 0495810014),
('Marnie', '2017-01-01' , 'F', 'Staffy', 'M', 'Y', 5, 'C0001', 0495810011);
...
INSERT INTO DUTIES (DUTY_TASK, DATE_SET, DATE_DUE, DOG_NAME, STAFF_ID, VOLUNTEER_NIK) VALUES
('Cleaning', '2018-10-30', '2018-11-07', 'Chevvy', 'C0002', 'Mike'),
('Vet visit', '2018-11-05', '2019-01-05', 'Yogi', 'C0001', 'Sally'),
('Grooming', '2018-11-04', '2018-12-23', 'Durah', 'C0002', 'Hik');
